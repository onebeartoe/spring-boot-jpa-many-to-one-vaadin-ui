...
//	public CustomerEditor(CustomerRepository repository, DocumentEditor documentEditor)
	public CustomerEditor(CustomerRepository repository, DocumentRepository documentRepository)
        {
...
//            this.documentEditor = documentEditor;
		...
		primaryContent.setSpacing(true);
	...
	public final void editCustomer(Customer c) 
		...
		binder.setBean(customer);
                ...
                var idValue = customer.getId() == null ? "" : customer.getId().toString();
                id.setValue( idValue );
      

		setVisible(true);
                
//!!!!TODO!!! setup the DocumentEditor with c.getId()
//            documentEditor.listDocuments(customer);
